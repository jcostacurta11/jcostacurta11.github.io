...
## Haverford College
### MATH/STAT 361: Applied Multivariate Statistical Analysis
I am currently teaching our upper-level regression modeling course required for all statistics concentrators (within the math/stat major) and minors. I also taught this course in fall 2025. We learn about linear and logistic regression models and apply them in R to real-world datasets (many of which have a Philly/PA connection!). 
### MATH/STAT 103: Introduction to Probability and Statistics
In spring 2026, I taught our introductory statistics course for students without a calculus background. We worked from the open-source textbook [Introduction to Modern Statistics](https://www.openintro.org/book/ims/).

## Stanford University
### ENGR 108: Introduction to Matrix Methods
In summer 2024, I taught my own course as instructor of record! I taught [ENGR 108: Introduction to Matrix Methods](https://web.stanford.edu/class/engr108/), an upper-level undergraduate course in applied linear algebra. Throughout the summer, we learned foundational topics in linear algebra for computation, building up to least-squares model fitting. Along the way, we also practiced implementing what we learned in Python.
...
I taught workshops on programming in Python and R via the Stanford Carpentries, and hold a teaching certification from the international [Carpentries network](https://carpentries.org/).
### Center for Teaching and Learning
* I served as a [Graduate Teaching Consultant](https://ctl.stanford.edu/grad-teaching/teaching-consultants) from 2024-2025. In this role I conducted small-group feedback sessions for graduate teaching assistants, provided teaching consultations, and delivered workshops on effective teaching strategies during TA orientations.
* I served as an [Engineering Learning Consultant](https://studentlearning.stanford.edu/academic-skills/peer-learning-consultant-program/meet-team) from 2022-2024. In this role I helped develop workshops on data visualization and LaTeX. I also taught as a co-instructor for a scientific Python bootcamp offered to visiting students in the Stanford Equity & Inclusion Office's summer programs.
...
I taught section, graded HW/exams, and held office hours for the following courses:
